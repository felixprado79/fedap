...
Connects to the database using the sync URL from app settings,
and uses the metadata from all models so autogenerate works.
"""
...
# Wire Python logging to the alembic.ini settings
...
# Override the URL from .ini with the one built from our settings
