...
/**
 * WhatsAppFAB — floating action button pinned to the bottom-right corner.
 *
 * Visible on every page after the user scrolls past the hero.
...
export default function WhatsAppFAB() {
  ...
  // Only show once the user has scrolled past the initial viewport
  useEffect(() => {
  ...
  return (
    <a
      ...
      className={cn(
        ...
        "rounded-full bg-[#25D366] text-white shadow-lg shadow-green-400/40",
